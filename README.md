...
a.addTrack("first track",'magenta')
for i in range(25):
    a.addTrackFeature(1,str(random.randint(1,200)))

a.addGradientTrack("Second track",'blue',0,100)
for i in range(200):
    a.addTrackFeature(1,str(i),str(random.randint(0,100)))

for i in range(1,201):
    a.addTrackFeature(2,str(i),value=random.randint(0,100))

a.addBar('first bar','lightblue',1,50)
a.addBar('second bar','mediumpurple',1,50)

for i in range(1,201):
    a.addTrackBar(1,str(i),random.randint(1,51))
    a.addTrackBar(2,str(i),random.randint(1,51))
